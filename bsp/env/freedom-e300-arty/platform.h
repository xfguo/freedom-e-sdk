...
#define ZERO_BASE_ADDR _AC(0x0a000000,UL)
...
#define ZERO_SIZE _AC(0x2000000,UL)
#define SPI0_MMAP_ADDR _AC(0x20000000,UL)
#define SPI0_SIZE _AC(0x20000000,UL)
#define MEM_SIZE _AC(0x4000,UL)
...
#define ZERO_REG(offset) _REG32(ZERO_BASE_ADDR, offset)
